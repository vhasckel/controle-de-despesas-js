...
const addTransactionsIntoDOM = ({ amount, name, id }) => {
  //se 'amount' for menor que 'transaction', 'operator' irá guardar o valor '-', senão '+'.
  const operator = amount < 0 ? "-" : "+";

  //trocar a classe do CSS
  ...
  li.innerHTML = `
    ...
    <button class='delete-btn' onClick="removeTransaction(${id})">x</buttton>
    `;
